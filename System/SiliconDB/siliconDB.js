...
async function setAntiword(groupID) {
  try {
    ...
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, antiword: true };
      await axios.put(
        `${siliconDBUrl}/api/data/${groupID}`,
        newData
      );
...
// Checking the status of Antiword
...
async function delAntiword(groupID) {
  try {
    ...
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, antiword: false };
      await axios.put(
        `${siliconDBUrl}/api/data/${groupID}`,
        newData
      );
...
async function offGroup(groupID) {
  try {
    ...
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, botSwitch: true };
      await axios.put(
        `${siliconDBUrl}/api/data/${groupID}`,
        newData
      );
...
async function checkOffGroup(groupID) {
  try {
    ...
    if (response.data) {
      return response.data.botSwitch;
    }
  } catch (err) {
    return false;
  }
...
async function switchOnGroup(groupID) {
  try {
    ...
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, botSwitch: false };
      await axios.put(
        `${siliconDBUrl}/api/data/${groupID}`,
        newData
      );
...
/////////////////////////////////////////////////////////////////////////////////
// Turning on the Autoreact
async function setAutoreact(groupID) {
  try {
    const response = await axios.get(
      `${siliconDBUrl}/api/group/${groupID}`
    );
    if (response.status === 404 || !response.data) {
      await axios.post(`${siliconDBUrl}/api/group`, {
        id: groupID,
        autoreact: true,
      });
    }
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, autoreact: true };
      await axios.put(
        `${siliconDBUrl}/api/group/${groupID}`,
        newData
      );
...
// Checking the status of Autoreact
async function checkAutoreact(groupID) {
  try {
    ...
    if (response.data) {
      return response.data.autoreact;
    }
  } catch (err) {
    return false;
  }
...
async function delAutoreact(groupID) {
  try {
    ...
    if (response.data) {
      const oldData = response.data;
      const newData = { ...oldData, autoreact: false };
      await axios.put(
        `${siliconDBUrl}/api/group/${groupID}`,
        newData
      );
