  ...
  start: async (
    ...
    switch (inputCMD) {
      case "3dcristmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dchristmas ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "3dneon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dneon ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "3dspace":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dspace ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "3dstone":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dstone ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "bear":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}bear ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "blackpink":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}blackpink ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "blood":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}blood ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "bokeh":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}bokeh ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "candy":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}candy ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "carbon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}carbon ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "chocolate":
        if (!text) {
          doReact("❌");
          return m.reply(`Example: *${prefix}chocolate ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "christmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}christmas ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "circuit":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}circuit ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "cloud":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}cloud ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "deepsea":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}deepsea ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "demon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}demon ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "glitch":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "glitch2":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch2 ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "glitch3":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch3 ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "graffiti":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}graffiti ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "hollographic":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}holographic ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "joker":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}joker ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "lion":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}lion ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "magma":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}magma ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "matrix":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}matrix ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "neon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neon ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "neondevil":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neondevil ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "neongreen":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neonlight ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "papercut":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}papercut ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "pencil":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}pencil ${botName}t*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "pornhub":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}pornhub ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "scifi":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}scifi ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "sparklechristmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}schristmas ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "thunder":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}thunder ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "transformer":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}transformer ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "thunder2":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}thunder2 ${botName}*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "wall":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}wall ${botName}*`);
        }
        await doReact("🏮");
        maker
      ...
      case "wolf":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}wolf Atlas Bot , ${botName} , RA_ONE*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
