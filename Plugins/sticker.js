      ...
      switch (inputCMD) {
        ...
        case "sticker":
          if (/image/.test(mime)) {
            ...
            if ((quoted.msg || quoted).seconds > 15) {
              ...
              return Atlas.sendMessage(
                m.from,
                { text: "Please send a video less than 15 seconds." },
                { quoted: m }
              );
            }
            let stickerMess = new Sticker(mediaMess, {
            ...
            await doReact("❌");
            m.reply(
              `Please mention an *image/video* and type *${prefix}s* to create a sticker.`
            );
          }
          break;
        ...
        case "take":
          ...
          if (/webp/.test(mime)) {
            ...
            await doReact("❌");
            m.reply(
              `Please mention a *Sticker* and type *${prefix}steal <packname, authorname>* to create a sticker with your name.`
            );
          }
        ...
        case "stickercrop":
          if (/image/.test(mime)) {
            ...
            if ((quoted.msg || quoted).seconds > 15) {
              await doReact("❌");
              return m.reply("Please send a video less than 15 seconds.");
            }
            let stickerMess = new Sticker(mediaMess, {
              pack: packName,
              author: pushName,
            ...
            await doReact("❌");
            m.reply(
              `Please mention an *image/video* and type *${prefix}s* to create a cropped sticker.`
            );
          }
          break;
        ...
        case "stickermeme":
          if (/image/.test(mime)) {
            if (!text) {
              await doReact("❔");
              return m.reply(
                `Please type *${prefix}smeme <text>* to create a sticker meme.`
              );
            }
            await doReact("📮");
            media = await Atlas.downloadAndSaveMediaMessage(quoted);
            ...
            await doReact("❌");
            m.reply(
              `Please mention an *image* and type *${prefix}smeme <text>* to create a sticker meme.`
            );
          }
          break;*/
