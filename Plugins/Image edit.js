...
module.exports = {
  ...
  start: async (Atlas, m, { inputCMD, text, doReact, mime, quoted, prefix, mentionByTag }) => {
    try {
      switch (inputCMD) {
        case "blur":
          try {
            ...
            console.error(error);
            m.reply("An error occurred while processing the 'blur' command.");
          }
          break;
        ...
        case "circle":
          try {
            if (/image/.test(mime)) {
              ...
              await doReact("❌");
              return m.reply(`Please mention an *image* and type *${prefix}circle* to create a circle image.`);
            }
          } catch (error) {
            console.error(error);
            m.reply("An error occurred while processing the 'circle' command.");
          }
          break;
        ...
        case "jail":
          try {
            ...
            console.error(error);
            m.reply("An error occurred while processing the 'jail' command.");
          }
          break;
        ...
        case "removebg":
          try {
            if (!m.quoted || !/image/.test(mime)) {
              await doReact("❌");
              return m.reply(`Send/Reply Image With Caption *${prefix}removebg* to remove the background of an image`);
            }
            if (/webp/.test(mime)) {
              await doReact("❌");
              return m.reply(`Send/Reply Image With Caption *${prefix}removebg* to remove the background of an image`);
          ...
          "cX3yucYC6KGb9U7ZqetGz91z",
            ...
            console.error(error);
            m.reply("An error occurred while processing the 'removebg' command.");
          }
          break;
